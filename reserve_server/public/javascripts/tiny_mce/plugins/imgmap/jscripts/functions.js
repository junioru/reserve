...
//	img_obj = editor.selection.getNode();
	img_obj = editor.dom.get('floorplan_img');
...
//      editor.setContent(document.getElementById('html_container').value);	
      tinyMCEPopup.close();
}
...
function gui_addArea(id) {
	...
	var temp = '<input type="text"  name="img_id" class="img_id" value="Select" readonly="1" />';
	...
	temp+= '</select>';
	temp+= ' <input type="text" name="img_coords" class="img_coords" value="" style = "display : none">';
	temp+= ' <input type="text" name="img_href" class="img_href" value="" style = "display : none">';
	temp+= ' <input type="text" name="img_alt" class="img_alt" value="" style = "display : none">';
